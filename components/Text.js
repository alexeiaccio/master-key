  ...
  return (
    <div className="text">
      ...
      <div className="section" style={{ backgroundColor: '#fff' }}>
        ...
        <div>
          3. Расправиться&nbsp;— броситься, прорасти, бытие-источником, пружина
          = spring = родник (он&nbsp;же ключ), ключ ключей (мастер-ключ),
          пружина протечет ключ-евой водой
        </div>
        <div>
        ...
        <div>
          ...
          <br />
          мастер ключ&nbsp;— зонтик ключей, мастер сюжет&nbsp;— зонтик сюжетов:
          квест, загадка, любовь запретная любовь, вражда, опасные излишества,
          героизм (бытовой?) и&nbsp;т.д.&nbsp;и&nbsp;т.п. -
        ...
        <div>
          ...
          и&nbsp;лишений: хорошо/плохо, горячо/холодно, сильно/слабо; тонкости
          поисков и&nbsp;побегов.
        </div>
        <div>
          11. Пожарная машина&nbsp;— на&nbsp;случай неконтролируемого возгорания
        </div>
        ...
        <div>
          27. Узелок: связь, привязь, соединение&nbsp;— один/полтора/два, память
          о&nbsp;пеленании
        </div>
        <div>28. Hot keys: горячие ключи, горячие клавиши</div>
        <div>
          29. Где мы&nbsp;— холодно-горячо, теплее, совсем горячо (поиск огня),
          лозоискательство (поиск источника) всё&nbsp;— территориальные игры
        </div>
