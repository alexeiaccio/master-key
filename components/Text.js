      ...
      {lang === 'eng' ? (
        <div className="section">
          <p>
            ...
            <br />
            4. Master key&nbsp;— key to&nbsp;many locks (to&nbsp;which many
            is&nbsp;kept quiet), change key&nbsp;— to&nbsp;some specific one,
            the key to&nbsp;change, the cashier gives you a&nbsp;key
            as&nbsp;change
            <br />
            5. Key plot twist
            <br />
          ...
          <p>20. Shadowban: I&nbsp;see everything, but&nbsp;I can’t speak</p>
          <p>21. The border key -|||--- ~ —O</p>
          <p>
            22. Safety nets (suicide nets), in&nbsp;their absence we&nbsp;hold
            hands (we&nbsp;are our own safety net)
          </p>
          <p>23. Where are&nbsp;we?</p>
          <p>24. A&nbsp;keyhole in&nbsp;a&nbsp;bow</p>
          <p>
            25.
            <p>
          ...
          <p>
            ...
            and is&nbsp;often not made explicit. It&nbsp;doesn’t matter what the
            thing&nbsp;is; what matters is&nbsp;everyone wants
            to&nbsp;possess&nbsp;it.
            <br />
            33. ‘Easy Come, Easy Go’, Jan Steen, 1661. Allegorical warning
            against gambling. Another title: ‘The Artist Eating Oysters’.
            In&nbsp;Russian the title is&nbsp;even more laconic: ‘Such
          ...
          <p>
            39. “We&nbsp;just need to&nbsp;go&nbsp;a&nbsp;little further,” said
            Camier, "until we&nbsp;can sense that we’ve reached the point where
            we&nbsp;have exactly enough strength to&nbsp;go&nbsp;back. Then
            we&nbsp;will turn and come here, to&nbsp;the ruins, completely
            exhausted.
            <br />
        ...
        <div className="section">
          <p>1. Пружина: сжатие, засада, напряжение перед прыжком</p>
          <p>2. Цель&nbsp;— какая? какая есть</p>
          <p>
          ...
          <p>
            ...
            —&nbsp;оседлать хотя&nbsp;бы нарратив, если больше нечего
          </p>
          <p>
          ...
          <p>8. Огни и&nbsp;клубнички: то&nbsp;и&nbsp;другое&nbsp;— hot</p>
          <p>
          ...
          <p>12. Is&nbsp;Swinging on&nbsp;a&nbsp;Swing Good Exercise?</p>
          <p>
          ...
          <p>(консервная банка не&nbsp;питательней, но&nbsp;полезней рыбы)</p>
          <p>
          ...
          <p>28. Hot keys: горячие ключи, горячие клавиши</p>
          <p>
            29. Где мы&nbsp;— холодно-горячо, теплее, совсем горячо (поиск
            огня), лозоискательство (поиск источника)
          </p>
          <p>всё&nbsp;— территориальные игры</p>
          <p>30. Метастабильные состояния*: клубничка на&nbsp;пригорке</p>
          <p>31. Хочу&nbsp;то, не&nbsp;знаю что</p>
          <p>
            ...
            не&nbsp;проясняется. «Не&nbsp;важно, что это за&nbsp;вещь; главное,
            что все хотят ею&nbsp;обладать»
          </p>
          <p>
            33. «Easy Come, Easy&nbsp;Go (Легко пришло, легко ушло)»,
            Ян&nbsp;Стен, 1661. Аллегория, предостерегающая от&nbsp;игры
            на&nbsp;ставки. Другая атрибуция: The artist eating oysters
            (Художник, поедающий устрицы). По-русски атрибутируется еще
            лаконичнее: «Таково течение жизни»
          </p>
          <p>34. Dead giveaway</p>
          <p>
          ...
          <p>
            39. —&nbsp;Просто нам нужно пройти еще немного,&nbsp;— сказал
            Камье,&nbsp;— пока не&nbsp;почувствуем, что
          </p>
          <p>
            дошли до&nbsp;того места, откуда нам хватит сил ровно на&nbsp;то,
            чтобы вернуться обратно. Тогда мы&nbsp;повернем и&nbsp;придем сюда,
            к&nbsp;развалинам, в&nbsp;полном изнеможении.
          </p>
          <p>—&nbsp;Это опасно,&nbsp;— сказал Мерсье.</p>
          <p>
            —&nbsp;Ты&nbsp;предложишь что-нибудь получше? —&nbsp;сказал Камье.
          </p>
          <p>
            —&nbsp;Может, просто поплясать здесь немного,&nbsp;— сказал
            Мерсье,&nbsp;— словом, поделать всякие резкие телодвижения. Это нам
            ничем не&nbsp;грозит. А&nbsp;когда с&nbsp;нас будет достаточно,
            рухнем без сил среди руин.
          </p>
          <p>
